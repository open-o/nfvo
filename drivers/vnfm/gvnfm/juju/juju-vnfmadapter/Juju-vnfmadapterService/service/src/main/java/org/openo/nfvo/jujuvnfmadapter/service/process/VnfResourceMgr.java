...
public class VnfResourceMgr {
    ...
    public JSONObject grantVnfResource(JSONObject compute, String vnfId) {
        LOG.warn("function=grantVnfResource, msg=enter to grant vnf resource, params: {}", compute);
        ...
        try {
            ...
            resultJson = VnfmRestfulUtil.sendReqToApp(UrlConstant.RES_VNF, Constant.PUT, reqParams);
