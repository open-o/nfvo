...
public class DiskLimitQueryTest {

    private DiskLimitQuery diskLimitQuery;
    ...
    public void setUp() {
        ...
        diskLimitQuery = new DiskLimitQuery(conMap);
    }
    ...
    public void testGetLimits() {
        ...
        new MockUp<VimRestfulUtil>() {
            ...
            public RestfulResponse getRemoteResponse(Map<String, String> paramsMap, String params,
                ...
                String responseString = "{\"quota_set\":{}}";
                rsp.setResponseJson(responseString);
                return rsp;
            }
        };
        JSONObject result = diskLimitQuery.getLimits();
    ...
    public void testGetLimitsByFail() {
        ...
        new MockUp<VimRestfulUtil>() {
            ...
            public RestfulResponse getRemoteResponse(Map<String, String> paramsMap, String params,
                    String domainTokens) {
                RestfulResponse rsp = new RestfulResponse();
                String responseString = "{\"quota_sets\":{}}";
                rsp.setResponseJson(responseString);
                return rsp;
            }
        };
