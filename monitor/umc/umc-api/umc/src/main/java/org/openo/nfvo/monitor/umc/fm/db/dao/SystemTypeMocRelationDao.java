 ...
 */
package org.openo.nfvo.monitor.umc.fm.db.dao;
...
public class SystemTypeMocRelationDao extends UmcDao<SystemTypeMocRelation> {
    ...
    public List<SystemTypeMocRelation> findAll() {
        ...
        try {
            beginTransaction();
            list =
                    list(namedQuery("org.openo.nfvo.monitor.umc.fm.bean.SystemTypeMocRelation.findAll"));
    ...
    public List<SystemTypeMocRelation> findMocBySystemType(int systemType) {
        ...
        try {
            ...
            list =
                    list(namedQuery(
                            "org.openo.nfvo.monitor.umc.fm.bean.SystemTypeMocRelation.findMocBySystemType")
