 ...
 */
package org.openo.orchestrator.nfv.umc.db.entity;
...
import org.openo.orchestrator.nfv.umc.db.IEntityClass;
import org.openo.orchestrator.nfv.umc.i18n.I18n;

@Entity
@Table(name = "currentAlarm")
@NamedQueries({
        @NamedQuery(name = "org.openo.orchestrator.nfv.umc.fm.entity.CurrentAlarm.findAll", query = "SELECT p FROM CurrentAlarm p"),
        @NamedQuery(name = "org.openo.orchestrator.nfv.umc.fm.entity.CurrentAlarm.findByCondition", query = "SELECT curAlarm FROM CurrentAlarm curAlarm ")})
