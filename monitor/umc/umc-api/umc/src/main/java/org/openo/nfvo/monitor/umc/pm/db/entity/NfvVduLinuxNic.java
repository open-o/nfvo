 ...
 */
package org.openo.nfvo.monitor.umc.pm.db.entity;
...
@Entity
@Table(name = "NFV_VDU_LINUX_NIC")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NfvVduLinuxNic implements IHistoryPmDataPo, Serializable {

    private static final long serialVersionUID = 6544312894728327571L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NfvVduLinuxNic)) {
            return false;
        }

        final NfvVduLinuxNic that = (NfvVduLinuxNic) o;
