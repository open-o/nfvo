...
@Entity
@Table(name = "NFV_VDU_LINUX_CPU")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NfvVduLinuxCpu implements IHistoryPmDataPo, Serializable {

    private static final long serialVersionUID = 5802774106900534501L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NfvVduLinuxCpu)) {
            return false;
        }

        final NfvVduLinuxCpu that = (NfvVduLinuxCpu) o;
