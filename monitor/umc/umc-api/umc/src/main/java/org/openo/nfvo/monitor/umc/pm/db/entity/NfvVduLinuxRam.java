...
@Entity
@Table(name = "NFV_VDU_LINUX_RAM")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NfvVduLinuxRam implements IHistoryPmDataPo, Serializable {

    private static final long serialVersionUID = 6575478427631202340L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NfvVduLinuxRam)) {
            return false;
        }

        final NfvVduLinuxRam that = (NfvVduLinuxRam) o;
