...
@Entity
@Table(name = "NFV_HOST_LINUX_FS")
@Data
@NoArgsConstructor
@AllArgsConstructor
public class NfvHostLinuxFs implements IHistoryPmDataPo, Serializable {

    private static final long serialVersionUID = -4405014846414328481L;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof NfvHostLinuxFs)) {
            return false;
        }

        final NfvHostLinuxFs that = (NfvHostLinuxFs) o;
