 ...
 */
package org.openo.nfvo.monitor.umc.cometdserver;
...
import org.openo.nfvo.monitor.umc.util.CometdUtil;
import org.slf4j.Logger;
import org.slf4j.LoggerFactory;

public class CometdService {
	private static final Logger LOGGER = LoggerFactory.getLogger(CometdService.class);
    public static String PM_UPLOAD_CHANNEL = "/pm";
    public static String FM_UPLOAD_CHANNEL = "/fm";
    ...
    public void publish(String channel, Object message) throws CometdException {
        if (bayeux == null) {
            ...
            checkBayeuxServer();
            this.session = this.bayeux.newLocalSession("openo_dac_local_session~");
