...
/**
 * Startup H2 Database WebServer and TcpServer for Test.
 * 
 *
 */
public class H2DbServer {
    ...
    public static void startUp(){
        try {
            h2DbWebServer = Server.createWebServer(new String[] { "-web", "-webAllowOthers", "-webPort", "8505" });
            h2DbWebServer.start();

            h2DbTcpServer = Server.createTcpServer(new String[] { "-tcp", "-tcpAllowOthers", "-tcpPort", "8405" });
            h2DbTcpServer.start();
