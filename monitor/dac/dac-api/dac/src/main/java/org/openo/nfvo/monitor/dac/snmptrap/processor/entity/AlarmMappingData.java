...
@AllArgsConstructor
@NoArgsConstructor
public class AlarmMappingData
{
    private long alarmCode;
    private long alarmReasonCode;
    ...
    {
        return "AlarmMappingData [alarmCode=" + alarmCode + ", alarmReasonCode=" + alarmReasonCode + ", alarmSeverity="
            + alarmSeverity + ", bindsValue=" + bindsValue + ", entity=" + entity + ", eventType=" + eventType + "]";
    }
}
