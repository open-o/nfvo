...
import org.openo.nfvo.monitor.dac.DacApp;
...
public class ExtensionUtil {
    ...
    private static Map<String,  Map<String, List<Class<?>>>> extensionClassMap;//<extendID,<Key,{class,class}>>
    ...
    {
    	LOGGER.info("inject instance:"+classEntity);
    	 try {
    ...
    public static void main(String[] args) {
        String[] packageUrls =
                new String[] {DacApp.class.getPackage().getName(), "com.zte.ums.zenap.dac.ext"};
        init(packageUrls);
