...
class TestNfPackage(TestCase):
    ...
    def test_nf_pkg_on_boarding_when_on_boarding(self, mock_call_req):
        ...
        NfOnBoardingThread(csar_id = "2", vim_ids = ["1"], lab_vim_id = "", job_id = "3").run()
        ...
        mock_vals = {
            ...
            "/openoapi/catalog/v1/servicetemplates/queryingrawdata":
                [0, json.JSONEncoder().encode({
                    ...
                    "name": "4", "file_url": "5", "disk_format": "6", "description": "7"}}]}), '200'],
    ...
    def test_nf_on_boarding_when_timeout(self, mock_get_image, mock_create_image, 
        ...
        mock_vals = {
            ...
            [0, json.JSONEncoder().encode({
                "onBoardState": "onBoardFailed", "processState": "deleteFailed"}), '200'],
            "/openoapi/catalog/v1/servicetemplates/queryingrawdata":
             [0, json.JSONEncoder().encode({"rawData": {
                "metadata": {"id": "999", "vendor": "1", "vnfd_version": "2", "version": "3"}},
                "image_files": [{"properties": {
                "name": "4", "file_url": "5", "disk_format": "6", "description": "7"}}]}), '200'],
            "/openoapi/catalog/v1/csars/2/files?relativePath=5":
             [0, json.JSONEncoder().encode({
    ...
    def test_get_csar_successfully(self, mock_call_req):
        mock_call_req.return_value = [0, json.JSONEncoder().encode({
            "name": "1", "provider": "2", "version": "3", 
            "operationalState": "4", "usageState": "5",
            "onBoardState": "6", "processState": "7", 
            "deletionPending": "8", "downloadUri": "9",
            "createTime": "10", "modifyTime": "11", 
            "format": "12", "size": "13"
            }), '200']
